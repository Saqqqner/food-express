package ru.adel.manager.config;
...
import ru.adel.manager.client.RestClientProductsRestClient;
import ru.adel.manager.security.OAuthClientHttpRequestInterceptor;
